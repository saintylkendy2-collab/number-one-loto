...
function copySelectedTicket(){
  ...
  if(choix === "1"){
    copyTicketToJeux(selectedTicketToCopy, null, null);
    return;
  }

  if(choix === "2"){
    var amounts = {};
    var hasBor = false, hasMar = false, hasLoto = false;
    ...
    copyTicketToJeux(selectedTicketToCopy, amounts, lots2);
    return;
  }
  ...
  if(choix === "3"){
    ...
    copyTicketToJeux(selectedTicketToCopy, null, lots3);
    return;
  }
}
